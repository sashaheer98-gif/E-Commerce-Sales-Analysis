...
📌 Project Overview
This project demonstrates an end-to-end data analysis workflow using Power BI. The objective was to transform raw e-commerce sales data into meaningful business insights through structured data modeling and interactive dashboard development.
